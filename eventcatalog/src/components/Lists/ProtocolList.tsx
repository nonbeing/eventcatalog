      ...
      <div className="mx-auto w-full max-w-lg divide-y divide-white/5 rounded-xl bg-white/5">
        <Disclosure as="div" className="pb-8" defaultOpen={pills.length <= 10}>
          <DisclosureButton className="group flex w-full items-center justify-start space-x-4">
            ...
            <ChevronDownIcon className="size-5 ml-2 fill-gray-600 dark:fill-gray-400 group-data-[hover]:fill-gray-500 dark:group-data-[hover]:fill-gray-300 group-data-[open]:rotate-180" />
          </DisclosureButton>
