  ...
  columnHelper.accessor('data.ownedEvents', {
    ...
    cell: (info) => {
      ...
      if (events?.length === 0 || !events)
        return <div className="font-light text-sm text-gray-500 dark:text-gray-400 text-left italic">User owns no events</div>;
  ...
  columnHelper.accessor('data.ownedCommands', {
    ...
    cell: (info) => {
      ...
      if (commands?.length === 0 || !commands)
        return <div className="font-light text-sm text-gray-500 dark:text-gray-400 text-left italic">User owns no commands</div>;
  ...
  columnHelper.accessor('data.ownedQueries', {
    ...
    cell: (info) => {
      ...
      if (queries?.length === 0 || !queries)
        return <div className="font-light text-sm text-gray-500 dark:text-gray-400 text-left italic">User owns no queries</div>;
              ...
              {queries.map((query: CollectionEntry<'queries'>, index: number) => (
                <li key={`${query.data.id}-${index}`} className="py-1 group font-light ">
                  <a
                    ...
                    className="group-hover:text-primary flex space-x-1 items-center "
                  >
                    <div className={`flex items-center border border-gray-300 dark:border-gray-600 shadow-sm rounded-md h-full`}>
                      <span className="flex items-center">
  ...
  columnHelper.accessor('data.ownedServices', {
    ...
    cell: (info) => {
      ...
      if (services?.length === 0 || !services)
        return <div className="font-light text-sm text-gray-500 dark:text-gray-400 text-left italic">User owns no services</div>;
  ...
  columnHelper.accessor('data.associatedTeams', {
    ...
    cell: (info) => {
      ...
      if (teams?.length === 0 || !teams)
        return <div className="font-light text-sm text-gray-500 dark:text-gray-400 text-left italic">User is not associated with any teams</div>;
